...
:aasa002: pass:q[[underline]#Constraint AASa-002#: The base64url-encoded identifier of the link: https://admin-shell-io.github.io/aas-specs-antora/IDTA-01001/v3.1/spec-metamodel/common.html#has-semantics-attributes[semanticId] shall have a length of maximum 3072 characters.]
