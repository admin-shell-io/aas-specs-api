...
e|https://admin-shell.io/aas/API/3/1/DiscoveryServiceSpecification/SSP-002 |Indicates that the server implemented all details of the Discovery Service Specification Full Profile in version 3.0.
