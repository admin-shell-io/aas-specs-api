...
e| xref:PostAllAssetLinksById[PostAllAssetLinksById]  | (deprecated) Creates or replaces all asset identifier key-value-pairs linked to an Asset Administration Shell to edit discoverable content
...
e| xref:PostAllAssetInformationById[PostAllAssetInformationById]  |Creates or replaces the AssetInformation linked to an Asset Administration Shell to edit discoverable content
|===
...
====
Note: This operation has been deprecated with version 3.1.0
====
...
==== Operation PostAllAssetInformationById

[.table-with-appendix-table]
[width=100%,cols="25%,35%,10%,20%,10%"]
|===
h|Operation Name 4+e|[[PostAllAssetInformationById]]PostAllAssetInformationById
h|Explanation 4+a|
Creates or replaces the AssetInformation linked to an Asset Administration Shell to edit discoverable content.
The existing content might have to be deleted first.
h|semanticId 4+|`\https://admin-shell.io/aas/API/PostAllAssetInformationById/3/1`

h|Name h|Description h|Mand. h|Type h|Card.
5+h|Input Parameter
|aasIdentifier |The Asset Administration Shell’s unique ID |yes |string |1
|assetInformation a|
Object containing asset identifiers, which could be the globalAssetId and/or specificAssetIds.
|yes |link:https://admin-shell-io.github.io/aas-specs-antora/IDTA-01001/v3.1/spec-metamodel/core.html#AssetInformation[AssetInformation] |1
5+h|Output Parameter
|statusCode |Status code |yes |xref:specification/interfaces-payload.adoc#StatusCode[StatusCode] |1
|payload |AssetInformation created successfully |yes |link:https://admin-shell-io.github.io/aas-specs-antora/IDTA-01001/v3.1/spec-metamodel/core.html#AssetInformation[AssetInformation] |1
|===
