...
e|xref:PutAssetAdministrationShell[PutAssetAdministrationShell] a|Replaces the current Asset Administration Shell or create it if it does not exist
...
hh|Explanation 4+a|Replaces the Asset Administration Shell or create it if it does not exist
...
e|xref:PutSubmodel[PutSubmodel] a|Replaces the Submodel or creates it if it does not exist
...
5+h|Output Parameter
|statusCode |Status code |yes |xref:specification/interfaces-payload.adoc#StatusCode[StatusCode] |1
|payload |Updated submodel |no | link:https://admin-shell-io.github.io/aas-specs-antora/IDTA-01001/v3.1/spec-metamodel/core.html#Submodel[Submodel] |1
|===
...
|xref:PutBulkAssetAdministrationShellDescriptorsById[PutBulkAssetAdministrationShellDescriptorsById] a| Updates multiple existing Asset Administration Shell Descriptors or creates them if they do not exist
...
|limit |The maximum size of the result set |no |nonNegativeInteger |1
|cursor |The position from which to resume a result listing |no |string |1
|assetKind |The kind of the assets to retrieve (Type, Instance, Role, NotApplicable) | no |link:https://admin-shell-io.github.io/aas-specs-antora/IDTA-01001/v3.1/spec-metamodel/core.html#AssetKind[AssetKind] |1
...
e|xref:PutSubmodelDescriptorById[PutSubmodelDescriptorById] a|Replaces an existing submodel descriptor, i.e., replaces registration information or creates it if it does not exist
e|xref:PutBulkSubmodelDescriptorsById[PutBulkSubmodelDescriptorsById] a|Replaces one or more existing submodel descriptors, i.e., replaces registration information of several submodels or creates them if they do not exist
...
e|xref:PutAssetAdministrationShellById[PutAssetAdministrationShellById] a|Replaces an existing Asset Administration Shell or creates it if it does not exist.
...
5+h|Output Parameter
|statusCode |Status code |yes |xref:specification/interfaces-payload.adoc#StatusCode[StatusCode] |1
|payload |Replaced Asset Administration Shell | no |link:https://admin-shell-io.github.io/aas-specs-antora/IDTA-01001/v3.1/spec-metamodel/core.html#AssetAdministrationShell[AssetAdministrationShell] |1
|===
...
|xref:PutSubmodelById[PutSubmodelById] a|Replaces an existing Submodel or creates it if it does not exist.
...
5+h|Output Parameter
|statusCode |Status code |yes |xref:specification/interfaces-payload.adoc#StatusCode[StatusCode] |1
|payload |Replaced Submodel | no | link:https://admin-shell-io.github.io/aas-specs-antora/IDTA-01001/v3.1/spec-metamodel/core.html#Submodel[Submodel] |1
|===
...
e|xref:PutConceptDescriptionById[PutConceptDescriptionById] |Replaces an existing Concept Description or creates it if it does not exist
...
5+h|Output Parameter
|statusCode |Status code |yes |xref:specification/interfaces-payload.adoc#StatusCode[StatusCode] |1
|payload |Replaced Concept Description |no |link:https://admin-shell-io.github.io/aas-specs-antora/IDTA-01001/v3.1/spec-metamodel/concept-description.html#ConceptDescription[ConceptDescription] |1
|===
