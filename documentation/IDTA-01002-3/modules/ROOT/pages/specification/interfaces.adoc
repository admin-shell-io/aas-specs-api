...
h|Explanation 4+a|Replaces the Submodel or creates it if it does not exist
...
5+h|Output Parameter
|statusCode |Status code |yes |xref:specification/interfaces-payload.adoc#StatusCode[StatusCode] |1
|payload |Replaced submodel |yes | link:https://industrialdigitaltwin.io/aas-specifications/IDTA-01001/v3.1/spec-metamodel/core.html#Submodel[Submodel] |1
|===
...
5+h|Output Parameter
|StatusCode |Status code |yes |xref:specification/interfaces-payload.adoc#StatusCode[StatusCode] |1
|payload |Replaced submodel element | no |link:https://industrialdigitaltwin.io/aas-specifications/IDTA-01001/v3.1/spec-metamodel/core.html#SubmodelElement[SubmodelElement] |1
|===
...
|xref:PutAssetAdministrationShellDescriptorById[PutAssetAdministrationShellDescriptorById] a|Replaces an existing Asset Administration Shell Descriptor, i.e., replaces registration information or creates it if it does not exist
...
h|Explanation 4+a|Replaces an existing Asset Administration Shell Descriptor, i.e., replaces registration information or creates it if it does not exist
...
5+h|Output Parameter
|statusCode |Status code |yes |xref:specification/interfaces-payload.adoc#StatusCode[StatusCode] |1
|payload |Replaced Concept Description |no |link:https://industrialdigitaltwin.io/aas-specifications/IDTA-01001/v3.1/spec-metamodel/concept-description.html#ConceptDescription[ConceptDescription] |1
|===
