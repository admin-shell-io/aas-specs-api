...
Each package in the list can be downloaded, uploaded, or deleted. New packages can also be added.

The Serialization interface enables the export of one or more specified AAS or Submodels in different serialization formats. 
Concept descriptions may be included or omitted in the output.

AASX packages are stored and managed independently from instantiated Asset Administration Shells or submodels on a server. 
...
[width=100%, cols="25%,35%,10%,20%,10%"]
|===
h|Operation Name 4+e|[[GetSubmodelElementByPat]]GetSubmodelElementByPath
...
|===
2+h|Interface: _Asset Administration Shell Registry_
h|Operation Name h|Description
...
e|xref:PostAssetAdministrationShell[PostAssetAdministrationShell] a|Creates a new Asset Administration Shell. The ID of the new Asset Administration Shell must be set in the payload.
...
The ID of the the new Concept Description must be set in the payload.
...
The Query Interface is substantially different to the other Interfaces. 
Queries enable the sender to formulate its information request in own many different means, while the receiver has to react to that degree of freedom. 
The Query Language (see Clause [TODO: insert reference]) defines the content of the inputs. 
An additional difference is the option for senders to select the desired format of the response data object. 
The concrete mechanics are defined in the technology-specific sections, e.g. Clause (see Clause [TODO: insert reference for the HTTP Query API]).


=== Query Interface and Operations
...
[%autowidth, width="100%", cols="45%,55%",options="header",]
|===
2+h|Interface: _Query_
h|Operation Name h|Description
e|xref:QueryAssetAdministrationShells[QueryAssetAdministrationShells] | Returns a list of Asset Administration Shells based on an input query.
e|xref:QuerySubmodels[QuerySubmodels] | Returns a list of Submodels based on an input query.
e|xref:QueryAssetAdministrationShellDescriptors[QueryAssetAdministrationShellDescriptors] | Returns a list of Asset Administration Shell Descriptors based on an input query.
e|xref:QuerySubmodelDescriptors[QuerySubmodelDescriptors] | Returns a list of Submodel Descriptors based on an input query.
e|xref:QueryConceptDescriptions[QueryConceptDescriptions] | Returns a list of Concept Descriptions based on an input query.
|===
...
h|Explanation 4+a|Returns a list of Asset Administration Shells based on an input query.
h|semanticId 4+|`\https://admin-shell.io/aas/API/QueryAssetAdministrationShells/3/1`

h|Name h|Description h|Mand. h|Type h|Card.
5+h|Input Parameter
|queryString | The specific string conformant to the AAS Query Language, containing filter conditions for the required Asset Administration Shells. | yes | QueryString |1
5+h|Output Parameter
|statusCode |Status code |yes |xref:specification/interfaces-payload.adoc#StatusCode[StatusCode] |1
|payload | List of requested Asset Administration Shells |no | Identifier / Asset Administration Shell |1..*
|===
...
h|Explanation 4+a|Returns a list of Submodels based on an input query.
h|semanticId 4+|`\https://admin-shell.io/aas/API/QuerySubmodels/3/1`

h|Name h|Description h|Mand. h|Type h|Card.
5+h|Input Parameter
|queryString | The specific string conformant to the AAS Query Language, containing filter conditions for the required Submodels. | yes | QueryString |1
5+h|Output Parameter
|statusCode |Status code |yes |xref:specification/interfaces-payload.adoc#StatusCode[StatusCode] |1
|payload | List of requested Submodels |no | Identifier / Submodel |1..*
|===
...
h|Explanation 4+a|Returns a list of Asset Administration Shell Descriptors based on an input query.
h|semanticId 4+|`\https://admin-shell.io/aas/API/QueryAssetAdministrationShellDescriptors/3/1`

h|Name h|Description h|Mand. h|Type h|Card.
5+h|Input Parameter
|queryString | The specific string conformant to the AAS Query Language, containing filter conditions for the required Asset Administration Shell Descriptors. | yes | QueryString |1
5+h|Output Parameter
|statusCode |Status code |yes |xref:specification/interfaces-payload.adoc#StatusCode[StatusCode] |1
|payload | List of requested Asset Administration Shell Descriptors |no | Identifier / Asset Administration Shell Descriptor |1..*
|===
...
h|Explanation 4+a|Returns a list of Submodel Descriptors based on an input query.
h|semanticId 4+|`\https://admin-shell.io/aas/API/QuerySubmodelDescriptors/3/1`

h|Name h|Description h|Mand. h|Type h|Card.
5+h|Input Parameter
|queryString | The specific string conformant to the AAS Query Language, containing filter conditions for the required Submodel Descriptors. | yes | QueryString |1
5+h|Output Parameter
|statusCode |Status code |yes |xref:specification/interfaces-payload.adoc#StatusCode[StatusCode] |1
|payload | List of requested Submodel Descriptors |no | Identifier / Submodel Descriptor |1..*
|===
...
h|Name h|Description h|Mand. h|Type h|Card.
5+h|Input Parameter
|queryString | The specific string conformant to the AAS Query Language, containing filter conditions for the required Concept Descriptions. | yes | QueryString |1
5+h|Output Parameter
|statusCode |Status code |yes |xref:specification/interfaces-payload.adoc#StatusCode[StatusCode] |1
|payload | List of requested Concept Descriptions |no | Identifier / Concept Description |1..*
|===
