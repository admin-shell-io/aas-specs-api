...
| QueryAssetAdministrationShellDescriptorIds a| Returns the identifiers of all Asset Administration Shell Descriptors that conform to a certain input query.
|===
...
h|Name h|Description h|Mand. h|Type h|Card.
5+h|Input Parameter
|query | Query object conforming to the AAS Query Language |yes | AAS Query |1
5+h|Output Parameter
|statusCode |Status code |yes |xref:specification/interfaces-payload.adoc#StatusCode[StatusCode] |1
|payload |List of Asset Administration Shell Descriptors |no | xref:specification/interfaces-payload.adoc#AssetAdministrationShellDescriptor[AssetAdministrationShellDescriptor]  |1..*
|===
...
==== Operation QueryAssetAdministrationShellDescriptorIds

[.table-with-appendix-table]
[width=100%, cols="25%,35%,10%,20%,10%"]
|===
h|Operation Name 4+e|QueryAssetAdministrationShellDescriptorIds
h|Explanation 4+a| Returns the identifiers of all Asset Administration Shell Descriptors that conform to a certain input query.
h|semanticId 4+|`\https://admin-shell.io/aas/API/QueryAssetAdministrationShellDescriptorIds/3/1`
...
5+h|Output Parameter
|statusCode |Status code |yes |xref:specification/interfaces-payload.adoc#StatusCode[StatusCode] |1
|payload |Identifiers of Asset Administration Shell Descriptors |no | Identifier |1..*
|===
...
| QuerySubmodelDescriptorIds a| Returns the identifiers of all Submodel Descriptors that conform to a certain input query.
|===
...
5+h|Output Parameter
|statusCode |Status code |yes |xref:specification/interfaces-payload.adoc#StatusCode[StatusCode] |1
|payload |List of Submodel Descriptors |no | xref:specification/interfaces-payload.adoc#SubmodelDescriptor[SubmodelDescriptor]  |1..*
|===


==== Operation QuerySubmodelDescriptorIds

[.table-with-appendix-table]
[width=100%, cols="25%,35%,10%,20%,10%"]
|===
h|Operation Name 4+e|QuerySubmodelDescriptorIds
h|Explanation 4+a| Returns the identifiers of all Submodel Descriptors that conform to a certain input query.
h|semanticId 4+|`\https://admin-shell.io/aas/API/QuerySubmodelDescriptorIds/3/1`
...
5+h|Output Parameter
|statusCode |Status code |yes |xref:specification/interfaces-payload.adoc#StatusCode[StatusCode] |1
|payload |Identifiers of Submodel Descriptors |no | Identifier |1..*
|===
...
e|QueryAssetAdministrationShellIds a| Returns the identifiers of all Asset Administration Shells that conform to a certain input query.
|===
...
5+h|Output Parameter
|statusCode |Status code |yes |xref:specification/interfaces-payload.adoc#StatusCode[StatusCode] |1
|payload |List of Asset Administration Shells |no | xref:specification/interfaces-payload.adoc#AssetAdministrationShell[AssetAdministrationShell]  |1..*
|===


==== Operation QueryAssetAdministrationShellIds

[.table-with-appendix-table]
[width=100%, cols="25%,35%,10%,20%,10%"]
|===
h|Operation Name 4+e|QueryAssetAdministrationShellIds
h|Explanation 4+a| Returns the identifiers of all Asset Administration Shells that conform to a certain input query.
h|semanticId 4+|`\https://admin-shell.io/aas/API/QueryAssetAdministrationShellIds/3/1`
...
5+h|Output Parameter
|statusCode |Status code |yes |xref:specification/interfaces-payload.adoc#StatusCode[StatusCode] |1
|payload |Identifiers of Asset Administration Shells |no | Identifier |1..*
|===
...
e|QuerySubmodelIds a| Returns the identifiers of all Submodels that conform to a certain input query.
|===
...
5+h|Output Parameter
|statusCode |Status code |yes |xref:specification/interfaces-payload.adoc#StatusCode[StatusCode] |1
|payload |List of Submodels |no | xref:specification/interfaces-payload.adoc#Submodel[Submodel]  |1..*
|===


==== Operation QuerySubmodelIds

[.table-with-appendix-table]
[width=100%, cols="25%,35%,10%,20%,10%"]
|===
h|Operation Name 4+e|QuerySubmodelIds
h|Explanation 4+a| Returns the identifiers of all Submodels that conform to a certain input query.
h|semanticId 4+|`\https://admin-shell.io/aas/API/QuerySubmodelIds/3/1`
...
5+h|Output Parameter
|statusCode |Status code |yes |xref:specification/interfaces-payload.adoc#StatusCode[StatusCode] |1
|payload |Identifiers of Submodels |no | Identifier |1..*
|===
...
5+h|Output Parameter
|statusCode |Status code |yes |xref:specification/interfaces-payload.adoc#StatusCode[StatusCode] |1
|payload | List of requested Concept Descriptions |no | Concept Description |1..*
|===

==== Operation QueryConceptDescriptionIds

[.table-with-appendix-table]
[width=100%, cols="25%,35%,10%,20%,10%"]
|===
h|Operation Name 4+e|QueryConceptDescriptionIds
h|Explanation 4+a|Returns the identifiers of Concept Descriptions based on an input query.
h|semanticId 4+|`\https://admin-shell.io/aas/API/QueryConceptDescriptionIds/3/1`
...
5+h|Output Parameter
|statusCode |Status code |yes |xref:specification/interfaces-payload.adoc#StatusCode[StatusCode] |1
|payload | List of requested Concept Descriptions |no | Identifier |1..*
|===
