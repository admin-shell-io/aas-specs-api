...
The value for the interface attribute shall be the concatenation of the interface-shortName, an optional serialisation modifier value, and the provided version. An non-existent serialisation modifier value represents the _normal_ serialisation.
