...
For metamodel elements like AssetAdministrationShell, Submodel, Identifier, etc. that are specified in Part 1 xref:bibliography.adoc#bib1[[1\]], please refer to the specification in Bibliography.
The AAS package format and the AAS Package type are defined in Part 5 xref:bibliography.adoc#bib3[[3\]].
...
e|assetKind |Denotes whether the asset of the described Asset Administration Shell is of kind “Type” or “Instance” |  link:https://admin-shell-io.github.io/aas-specs-antora/IDTA-01001/v3.1/spec-metamodel/core.html#AssetKind[AssetKind] |0..1
...
Unsuccessful operations return one of the failure status codes and a result object as defined in Clause 0.

Table 4 shows generic status codes returned to the requester.
