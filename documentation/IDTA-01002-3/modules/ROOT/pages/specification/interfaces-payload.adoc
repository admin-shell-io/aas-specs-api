...
h|Inherits from 3+|--
h|semanticId 3+|`\https://admin-shell.io/aas/API/DataTypes/Descriptor/3/2`
...
|link:https://industrialdigitaltwin.io/aas-specifications/IDTA-01001/v3.2/spec-metamodel/datatypes.html#MultiLanguageTextType[MultiLanguageTextType] |0..1

e|displayName a|Display name; can be provided in several languages | link:https://industrialdigitaltwin.io/aas-specifications/IDTA-01001/v3.2/spec-metamodel/datatypes.html#MultiLanguageNameType[MultiLanguageNameType] |0..1

e|extension a|An extension of the element |link:https://industrialdigitaltwin.io/aas-specifications/IDTA-01001/v3.2/spec-metamodel/common.html#Extension[Extension] |0..*
|===
...
h|semanticId 3+|`\https://admin-shell.io/aas/API/DataTypes/AssetAdministrationShellDescriptor/3/2`

h|Attribute h|Explanation h| Type h|Card.
e|administration |Administrative information of the Asset Administration Shell | link:https://industrialdigitaltwin.io/aas-specifications/IDTA-01001/v3.2/spec-metamodel/common.html#AdministrativeInformation[AdministrativeInformation] |0..1
e|assetKind |Denotes whether the asset of the described Asset Administration Shell is of kind “Type”, “Instance”, ”Role”, or "NotApplicable" |  link:https://industrialdigitaltwin.io/aas-specifications/IDTA-01001/v3.2/spec-metamodel/core.html#AssetKind[AssetKind] |0..1
e|assetType |The type of the asset described by the Asset Administration Shell of this Descriptor. See AssetInformation/assetType for further information. | link:https://industrialdigitaltwin.io/aas-specifications/IDTA-01001/v3.2/spec-metamodel/datatypes.html#Identifier[Identifier] |0..1
e|endpoint |Endpoint of the network resource | xref:Endpoint[Endpoint] |0..*
e|globalAssetId |Global reference to the asset the AAS is representing |link:https://industrialdigitaltwin.io/aas-specifications/IDTA-01001/v3.2/spec-metamodel/datatypes.html#Identifier[Identifier] |0..1
e|idShort |Short name of the Asset Administration Shell | link:https://industrialdigitaltwin.io/aas-specifications/IDTA-01001/v3.2/spec-metamodel/datatypes.html#NameType[NameType] |0..1
e|id |Globally unique identification of the Asset Administration Shell |link:https://industrialdigitaltwin.io/aas-specifications/IDTA-01001/v3.2/spec-metamodel/datatypes.html#Identifier[Identifier] |1
e|specificAssetId |Specific asset identifier | link:https://industrialdigitaltwin.io/aas-specifications/IDTA-01001/v3.2/spec-metamodel/core.html#SpecificAssetId[SpecificAssetId] |0..*
...
h|Inherits from 3+|xref:Descriptor[Descriptor]
h|semanticId 3+|`\https://admin-shell.io/aas/API/DataTypes/SubmodelDescriptor/3/2`

h|Attribute h|Explanation h| Type h|Card.
e|administration a|Administrative information of the Submodel |link:https://industrialdigitaltwin.io/aas-specifications/IDTA-01001/v3.2/spec-metamodel/common.html#AdministrativeInformation[AdministrativeInformation] |0..1
e|endpoint a|Endpoint of the network resource |xref:Endpoint[Endpoint] |1..*
e|idShort a|Short name of the Submodel |link:https://industrialdigitaltwin.io/aas-specifications/IDTA-01001/v3.2/spec-metamodel/datatypes.html#NameType[NameType] |0..1
e|id a|Globally unique identification of the Submodel |link:https://industrialdigitaltwin.io/aas-specifications/IDTA-01001/v3.2/spec-metamodel/datatypes.html#Identifier[Identifier] |1
e|semanticId a|Identifier of the semantic definition of the Submodel |link:https://industrialdigitaltwin.io/aas-specifications/IDTA-01001/v3.2/spec-metamodel/referencing.html#Reference[Reference] |0..1
e|supplementalSemanticId a|Identifier of a supplemental semantic definition of the element called supplemental semantic ID of the element |link:https://industrialdigitaltwin.io/aas-specifications/IDTA-01001/v3.2/spec-metamodel/referencing.html#Reference[Reference]  |0..*
|===
...
This class is not part of the metamodel.
h|Inherits from 3+|-
h|semanticId 3+|`\https://admin-shell.io/aas/API/DataTypes/Endpoint/3/2`
...
e|interface a|Name of the offered interface at the endpoint |link:https://industrialdigitaltwin.io/aas-specifications/IDTA-01001/v3.2/spec-metamodel/datatypes.html#NameType[NameType]  |1
|===
...
An non-existent serialisation modifier value represents the link:https://industrialdigitaltwin.io/aas-specifications/IDTA-01001/v3.2/mappings/mappings.html#_format_normal_in_json[Normal serialisation].
...
The interface-version of this specification is “3.2”, e.g. the entry for the Asset Administration Shell Interface is “AAS-3.2”.
...
h|Inherits from 3+|--
h|semanticId 3+|`\https://admin-shell.io/aas/API/DataTypes/ProtocolInformation/3/2`
...
e|endpointProtocolVersion |Array of strings, each entry represents one supported version at this very endpoint, the entry shall be formatted according to the regulations of the protocol specified in the href |link:https://industrialdigitaltwin.io/aas-specifications/IDTA-01001/v3.2/spec-metamodel/datatypes.html#NameType[NameType] |0..*
...
e|subprotocolBodyEncoding |If subprotocolBody is present, the encoding might be explicitly defined, otherwise it shall default to subprotocols encoding scheme |link:https://industrialdigitaltwin.io/aas-specifications/IDTA-01001/v3.2/spec-metamodel/datatypes.html#NameType[NameType] |0..1
...
h|Inherits from 3+|--
h|semanticId 3+|`\https://admin-shell.io/aas/API/DataTypes/SecurityAttributeObject/3/2`
...
h|semanticId |`\https://admin-shell.io/aas/API/DataTypes/SecurityTypeEnum/3/2`

.2+h|Literal h| ID
h|Explanation

.2+e|NONE |`\https://admin-shell.io/aas/API/DataTypes/SecurityTypeEnum/NONE/3/2`
a|No predefined security type available

.2+e|RFC_TLSA |`\https://admin-shell.io/aas/API/DataTypes/SecurityTypeEnum/RFC_TLSA/3/2`
a|TLSA according to RFC 6698

.2+e|W3C_DID |`\https://admin-shell.io/aas/API/DataTypes/SecurityTypeEnum/W3C_DID/3/2`
...
h|Inherits from 3+|-
h|semanticId 3+|`\https://admin-shell.io/aas/API/DataTypes/AssetLink/3/2`

h|Attribute h|Explanation h| Type h|Card.
e|name |Name of the Asset identifier, i.e., "globalAssetId", a serial number, manufacturer part ID, or customer part IDs | link:https://industrialdigitaltwin.io/aas-specifications/IDTA-01001/v3.2/spec-metamodel/datatypes.html#LabelType[LabelType] |1
e|value |Value of the Asset Identifier |  link:https://industrialdigitaltwin.io/aas-specifications/IDTA-01001/v3.2/spec-metamodel/datatypes.html#Identifier[Identifier] |1
|===
...
h|Inherits from 3+|--
h|semanticId 3+| `\https://admin-shell.io/aas/API/DataTypes/ServiceDescription/3/2`
...
h|semanticId |`\https://admin-shell.io/aas/API/DataTypes/ServiceSpecificationProfileEnum/3/2`
...
e|https://admin-shell.io/aas/API/3/2/AssetAdministrationShellServiceSpecification/SSP-001 |Indicates that the server implemented all features of the Asset Administration Shell Service Specification Full Profile in version 3.2.
...
e|https://admin-shell.io/aas/API/3/2/AssetAdministrationShellServiceSpecification/SSP-002 |Indicates that the server implemented all features of the Asset Administration Shell Service Specification Read Profile in version 3.2.
...
e|https://admin-shell.io/aas/API/3/2/SubmodelServiceSpecification/SSP-001 |Indicates that the server implemented all features of the Submodel Service Specification Full Profile in version 3.2.
...
e|https://admin-shell.io/aas/API/3/2/SubmodelServiceSpecification/SSP-002 |Indicates that the server implemented all features of the Submodel Service Specification Value Profile in version 3.2.
...
e|https://admin-shell.io/aas/API/3/2/SubmodelServiceSpecification/SSP-003 |Indicates that the server implemented all features of the Submodel Service Specification Read Profile in version 3.2.
...
e|https://admin-shell.io/aas/API/3/2/AasxFileServerServiceSpecification/SSP-001 |Indicates that the server implemented all details of the AASX File Server Service Specification Full Profile in version 3.2.
e|https://admin-shell.io/aas/API/3/1/AasxFileServerServiceSpecification/SSP-002 |Indicates that the server implemented all details of the AASX File Server Service Specification Read Profile in version 3.1.
e|https://admin-shell.io/aas/API/3/2/AasxFileServerServiceSpecification/SSP-002 |Indicates that the server implemented all details of the AASX File Server Service Specification Read Profile in version 3.2.
...
e|https://admin-shell.io/aas/API/3/2/AssetAdministrationShellRegistryServiceSpecification/SSP-001 |Indicates that the server implemented all details of the Asset Administration Shell Registry Service Specification Full Profile in version 3.2.
...
e|https://admin-shell.io/aas/API/3/2/AssetAdministrationShellRegistryServiceSpecification/SSP-002 |Indicates that the server implemented all details of the Asset Administration Shell Registry Service Specification Read Profile in version 3.2.
...
e|https://admin-shell.io/aas/API/3/2/AssetAdministrationShellRegistryServiceSpecification/SSP-003 |Indicates that the server implemented all details of the Asset Administration Shell Registry Service Specification Bulk Profile in version 3.2.
...
e|https://admin-shell.io/aas/API/3/2/AssetAdministrationShellRegistryServiceSpecification/SSP-004 |Indicates that the server implemented all details of the Asset Administration Shell Registry Service Specification Query Profile in version 3.2.
...
e|https://admin-shell.io/aas/API/3/2/AssetAdministrationShellRegistryServiceSpecification/SSP-005 |Indicates that the server implemented all details of the Asset Administration Shell Registry Service Specification Minimal Read Profile in version 3.2.
...
e|https://admin-shell.io/aas/API/3/2/SubmodelRegistryServiceSpecification/SSP-001 |Indicates that the server implemented all details of the Submodel Registry Service Specification Full Profile in version 3.2.
...
e|https://admin-shell.io/aas/API/3/2/SubmodelRegistryServiceSpecification/SSP-002 |Indicates that the server implemented all details of the Submodel Registry Service Specification Read Profile in version 3.2.
...
e|https://admin-shell.io/aas/API/3/2/SubmodelRegistryServiceSpecification/SSP-003 |Indicates that the server implemented all details of the Submodel Registry Service Specification Bulk Profile in version 3.2.
...
e|https://admin-shell.io/aas/API/3/2/SubmodelRegistryServiceSpecification/SSP-004 |Indicates that the server implemented all details of the Submodel Registry Service Specification Query Profile in version 3.2.
...
e|https://admin-shell.io/aas/API/3/2/DiscoveryServiceSpecification/SSP-001 |Indicates that the server implemented all details of the Discovery Service Specification Full Profile in version 3.2.
e|https://admin-shell.io/aas/API/3/2/DiscoveryServiceSpecification/SSP-002 |Indicates that the server implemented all details of the Discovery Service Specification Read Profile in version 3.1.
...
e|https://admin-shell.io/aas/API/3/2/AssetAdministrationShellRepositoryServiceSpecification/SSP-001 |Indicates that the server implemented all details of the Asset Administration Shell Repository Service Specification Read Profile in version 3.2.
...
e|https://admin-shell.io/aas/API/3/2/AssetAdministrationShellRepositoryServiceSpecification/SSP-002 |Indicates that the server implemented all details of the Asset Administration Shell Repository Service Specification Read Profile in version 3.2.
...
e|https://admin-shell.io/aas/API/3/2/AssetAdministrationShellRepositoryServiceSpecification/SSP-003 |Indicates that the server implemented all details of the Asset Administration Shell Repository Service Specification Query Profile in version 3.2.
e|https://admin-shell.io/aas/API/3/2/AssetAdministrationShellRepositoryServiceSpecification/SSP-004 |Indicates that the server implemented all details of the Asset Administration Shell Repository Service Specification Signature Profile in version 3.2.
e|https://admin-shell.io/aas/API/3/2/AssetAdministrationShellRepositoryServiceSpecification/SSP-005 |Indicates that the server implemented all details of the Asset Administration Shell Repository Service Specification Identifiable Profile in version 3.2.
...
e|https://admin-shell.io/aas/API/3/2/SubmodelRepositoryServiceSpecification/SSP-001 |Indicates that the server implemented all details of the Submodel Service Repository Specification Full Profile in version 3.2.
...
e|https://admin-shell.io/aas/API/3/2/SubmodelRepositoryServiceSpecification/SSP-002 |Indicates that the server implemented all details of the Submodel Service Repository Specification Read Profile in version 3.2.
e|https://admin-shell.io/aas/API/3/0/SubmodelRepositoryServiceSpecification/SSP-003 |Indicates that the server implemented all details of the Submodel Service Repository Specification Template Profile in version 3.0.
e|https://admin-shell.io/aas/API/3/1/SubmodelRepositoryServiceSpecification/SSP-003 |Indicates that the server implemented all details of the Submodel Service Repository Specification Template Profile in version 3.1.
e|https://admin-shell.io/aas/API/3/2/SubmodelRepositoryServiceSpecification/SSP-003 |Indicates that the server implemented all details of the Submodel Service Repository Specification Template Profile in version 3.2.
e|https://admin-shell.io/aas/API/3/0/SubmodelRepositoryServiceSpecification/SSP-004 |Indicates that the server implemented all details of the Submodel Service Repository Specification Template Read Profile in version 3.0.
e|https://admin-shell.io/aas/API/3/1/SubmodelRepositoryServiceSpecification/SSP-004 |Indicates that the server implemented all details of the Submodel Service Repository Specification Template Read Profile in version 3.1.
e|https://admin-shell.io/aas/API/3/2/SubmodelRepositoryServiceSpecification/SSP-004 |Indicates that the server implemented all details of the Submodel Service Repository Specification Template Read Profile in version 3.2.
...
e|https://admin-shell.io/aas/API/3/2/SubmodelRepositoryServiceSpecification/SSP-005 |Indicates that the server implemented all details of the Submodel Service Repository Specification Query Profile in version 3.2.
e|https://admin-shell.io/aas/API/3/2/SubmodelRepositoryServiceSpecification/SSP-006 |Indicates that the server implemented all details of the Submodel Service Repository Specification Signature Profile in version 3.2.
...
e|https://admin-shell.io/aas/API/3/2/ConceptDescriptionRepositoryServiceSpecification/SSP-002 |Indicates that the server implemented all details of the Concept Description Repository Service Specification Query Profile in version 3.2.
...
e|https://admin-shell.io/aas/API/3/2/ConceptDescriptionRepositoryServiceSpecification/SSP-002 |Indicates that the server implemented all details of the Concept Description Repository Service Specification Query Profile in version 3.2.
e|https://admin-shell.io/aas/API/3/2/ConceptDescriptionRepositoryServiceSpecification/SSP-003 |Indicates that the server implemented all details of the Concept Description Repository Service Specification Signature Profile in version 3.2.
|===
...
Finding recently added or changed elements in the repository is required in several use cases.
Since the number of changed objects can be very large the result of such a query might be paginated and only contain the identifiers of the changed objects and a few supporting attributes.
The following table describes the data types used for such a result.


[.table-with-appendix-table]
[cols="25%,40%,25%,10%"]
|===
h|Class Name 3+e|[[RecentChange]]RecentChange
h|Explanation 3+a|
...
h|Attribute h|Explanation h|Type h|Card.
e|createdAt a|The point in time at which the Identifiable object was created |link:https://industrialdigitaltwin.io/aas-specifications/IDTA-01001/v3.2/spec-metamodel/datatypes.html#DateTimeUtc[DateTimeUtc] | 1
e|updatedAt a|The point in time at which the Identifiable object was recently updated |link:https://industrialdigitaltwin.io/aas-specifications/IDTA-01001/v3.2/spec-metamodel/datatypes.html#DateTimeUtc[DateTimeUtc] | 1
...
[cols="25%,40%,25%,10%"]
|===
h|Class Name 3+e|[[AssetAdministrationShellRecentChange]]AssetAdministrationShellRecentChange
h|Explanation 3+a|
...
h|Inherits from 3+|xref:RecentChange[RecentChange]
h|semanticId 3+| `\https://admin-shell.io/aas/API/DataTypes/AssetAdministrationShellRecentChange/3/2`
...
[cols="25%,40%,25%,10%"]
|===
h|Class Name 3+e|[[ConceptDescriptionRecentChange]]ConceptDescriptionRecentChange
h|Explanation 3+a|
...
h|Inherits from 3+|xref:RecentChange[RecentChange]
h|semanticId 3+| `\https://admin-shell.io/aas/API/DataTypes/ConceptDescriptionRecentChange/3/2`
...
[cols="25%,40%,25%,10%"]
|===
h|Class Name 3+e|[[SubmodelRecentChange]]SubmodelRecentChange
h|Explanation 3+a|
...
h|Inherits from 3+|xref:RecentChange[RecentChange]
h|semanticId 3+| `\https://admin-shell.io/aas/API/DataTypes/SubmodelRecentChange/3/2`
...
All simple data types from link:https://industrialdigitaltwin.io/aas-specifications/IDTA-01001/v3.2/spec-metamodel/datatypes.html#predefined_simple_data_types[Part 1] xref:bibliography.adoc#bib1[[1\]] apply also to the specifications described in this document.
...
All primitive data types from link:https://industrialdigitaltwin.io/aas-specifications/IDTA-01001/v3.2/spec-metamodel/datatypes.html#primitive-data-types[Part 1] apply also to the specifications described in this document.
...
If the requester is directed to another location, the operation can return a redirection status code.
A redirection does not return a Result object; the technology binding defines how the alternative location is conveyed.
...
|RedirectionFound |The requested resource can be requested at another location |No
...
h|Inherits from 3+|--
h|semanticId 3+|`\https://admin-shell.io/aas/API/DataTypes/Result/3/2`
...
h|Inherits from 3+|--
h|semanticId 3+|`\https://admin-shell.io/aas/API/DataTypes/Message/3/2`
...
h|semanticId |`\https://admin-shell.io/aas/API/DataTypes/MessageTypeEnum/3/2`
...
h|Inherits from 3+|--
h|semanticId* 3+|`\https://admin-shell.io/aas/API/DataTypes/OperationRequest/3/2`

h|Attribute h|Explanation h|Type h|Card.

|inputArguments a|Input argument | link:https://industrialdigitaltwin.io/aas-specifications/IDTA-01001/v3.2/spec-metamodel/submodel-elements.html#OperationVariable[OperationVariable] |0..*
|inoutputArguments a|InOutput argument |link:https://industrialdigitaltwin.io/aas-specifications/IDTA-01001/v3.2/spec-metamodel/submodel-elements.html#OperationVariable[OperationVariable] |0..*
...
h|Explanation 3+a|The operation request object
h|Inherits from 3+|--
h|semanticId* 3+|`\https://admin-shell.io/aas/API/DataTypes/OperationRequestValueOnly/3/2`

h|Attribute h|Explanation h|Type h|Card.

|inputArguments a|Input argument | link:https://industrialdigitaltwin.io/aas-specifications/IDTA-01001/v3.2/mappings/mappings.html#json-schema-value-only[ValueOnly] |0..*
|inoutputArguments a|InOutput argument |link:https://industrialdigitaltwin.io/aas-specifications/IDTA-01001/v3.2/mappings/mappings.html#json-schema-value-only[ValueOnly] |0..*
|clientTimeoutDuration a|Duration indicating when the client suggests the server to have finished execution of the invoked operation. The server may take this value into account to decide on its effective timeout, however, the server may or may not use by its own discretion. |duration |0..1
|===
...
h|semanticId 3+|`\https://admin-shell.io/aas/API/DataTypes/BaseOperationResult/3/2`
...
h|semanticId 3+|`\https://admin-shell.io/aas/API/DataTypes/OperationResult/3/2`

h|Attribute h|Explanation h|Type h|Card.
e|outputArguments |Output argument |link:https://industrialdigitaltwin.io/aas-specifications/IDTA-01001/v3.2/spec-metamodel/submodel-elements.html#OperationVariable[OperationVariable] |0..*
e|inoutputArguments |InOutput argument |link:https://industrialdigitaltwin.io/aas-specifications/IDTA-01001/v3.2/spec-metamodel/submodel-elements.html#OperationVariable[OperationVariable] |0..*
|===
...
h|Attribute h|Explanation h|Type h|Card.
e|outputArguments |Output argument |link:https://industrialdigitaltwin.io/aas-specifications/IDTA-01001/v3.2/mappings/mappings.html#json-schema-value-only[ValueOnly] |0..*
e|inoutputArguments |InOutput argument |link:https://industrialdigitaltwin.io/aas-specifications/IDTA-01001/v3.2/mappings/mappings.html#json-schema-value-only[ValueOnly] |0..*
|===
...
h|semanticId |`\https://admin-shell.io/aas/API/DataTypes/ExecutionState/3/2`
...
h|Inherits from 3+|--
h|semanticId  3+|`\https://admin-shell.io/aas/API/DataTypes/OperationHandle/3/2`
