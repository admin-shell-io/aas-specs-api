...
h|Attribute h|Explanation h| Type h|Card.
e|name |Name of the Asset identifier, i.e., "specificAssetId" or "globalAssetId" | link:https://admin-shell-io.github.io/aas-specs-antora/IDTA-01001/v3.1/spec-metamodel/datatypes.html#LabelType[LabelType] |1
