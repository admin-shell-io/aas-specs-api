...
Finding recently added or changed elements in the repository is required in several use cases. Since the number of changed objects can be very large the result of such a query might be paginated and only contain the identifiers of the changed objects and a few supporting attributes. The following table describes the data types used for such a result.
