= Part 2: Application Programming Interfaces (IDTA-01002-3-1) - in progress
...
<<<<<<< HEAD
This is version 3.2.0 of the specification IDTA-01002.

Previous version: 3.1.3
=======
This is version 3.1.3 of the specification IDTA-01002.
...
DOI: https://doi.org/10.62628/IDTA.01002-3-1-3
>>>>>>> origin/main
