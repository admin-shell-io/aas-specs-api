...
Additionally, "Release candidates" are variants of the implementation of the denoted major version. For example, "3.1.0 RC2" should be interpreted as the second (alternative) release candidate for version 3.1.0.
...
image::image88.png[Ein Bild, das Dunkel enthält. Automatisch generierte Beschreibung,width=481,height=110]
...
====
Note: The profiles provided at the "/description" endpoint (see Clause 10.2.6) contain both the major and minor version declaration.
====
