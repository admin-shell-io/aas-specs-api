...
h|Operation  h|Kind of Change h|Comment
 ...
 |GetAllAssetAdministrationShellsRecentChanges  | New  a| new API-Operation for AAS Repository interface to retrieve recently changed or created AAS with an optimized return object
 |GetAllSubmodelsRecentChanges  | New  a| new API-Operation for Submodel Repository interface to retrieve recently changed or created Submodels with an optimized return object
 |GetAllConceptDescriptionsRecentChanges  | New  a| new API-Operation for Concept Description Repository interface to retrieve recently changed or created Concept Descriptions with an optimized return object
|===
