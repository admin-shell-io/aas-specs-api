...
* Switching from SwaggerHub to GitHub Pages [link](https://industrialdigitaltwin.io/aas-specs-api/docs/index.html) for the maintenance of OpenAPI files. Versions until v3.1.3 are still available on SwaggerHub, but all new versions will be published on GitHub Pages.
