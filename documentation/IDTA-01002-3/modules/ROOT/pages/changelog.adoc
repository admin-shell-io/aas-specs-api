...
| |Asset Administration Shell Registry Interface  |Extended a| new API operation for retrieving changed objects: GetAllAssetAdministrationShellDescriptorsRecentChanges
...
| |Submodel Registry Interface  |Extended a| new API operation for retrieving changed objects: GetAllSubmodelDescriptorsRecentChanges
|===
