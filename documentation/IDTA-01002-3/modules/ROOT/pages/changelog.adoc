...
| |AASX File Server Interface  |Extended a| new API operations for asyncronous creation: PostAsyncAASXPackag, GetAasxAsyncStatus, GetAasxAsyncResult (https://github.com/admin-shell-io/aas-specs-api/issues/347[#347])
