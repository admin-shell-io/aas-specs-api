...
* Changed SupplementalSemanticId to SupplementalSemanticIds in the OpenAPI file for the Part 1 classes to match the definition in the Part 1 OpenAPI file. (https://github.com/admin-shell-io/aas-specs-api/issues/553[#553])
