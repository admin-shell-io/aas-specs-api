...
| | PostAllAssetLinksById|Changed a| Changed cardinality of the payload from “1” to “1..*”
...
h|Operation  h|Kind of Change h|Comment
 ...
 | PostAllAssetInformationById|new a| new API-Operation for the Discovery Service Interface
 | PostAllAssetLinksById|changed a| deprecated
|===
...
added new API-operation SearchAllAssetAdministrationShellIdsByAssetLink
 |Discovery Profile - Full Profile |new a| Added the PostAllAssetInformationById API Operation
