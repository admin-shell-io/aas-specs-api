...
* changed: Removed whitespaces from several clauses and fixed an issue with the idShortPath definition in the BNF Grammar of the Query Language [#477](https://github.com/admin-shell-io/aas-specs-api/issues/477).
