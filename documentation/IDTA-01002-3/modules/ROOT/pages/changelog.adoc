...
* xref:http-rest-api/http-rest-api.adoc#mapping-of-operations[Mapping of Operations]: adding missing path for the row defining the mapping of PutAssetAdministrationShell to HTTP
