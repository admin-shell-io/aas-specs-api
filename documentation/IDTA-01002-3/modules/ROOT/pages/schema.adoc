....
{
  ...
  "definitions": {
    ...
    "modelStringPattern": {
      "type": "string",
      "pattern": "^\\$(aas|sm|sme|cd|aasdesc|smdesc)(\\..[^#]*)?\\#(idShort|displayName|description|id|(assetInformation.)?assetKind|(assetInformation.)?assetType|(assetInformation.)?globalAssetId|(assetInformation.)?specificAssetId|submodel|semanticId|value|valueType|submodelDescriptors|language).*$"
    },
    "hexLiteralPattern": {
      "type": "string",
      "pattern": "^16#[0-9A-F]+$"
