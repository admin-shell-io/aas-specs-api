...
include::IDTA-01002_SpecialParameters.adoc[]
...
5+h|Input Parameter
e|serializationModifier a|Defines the format of the response |no |xref:SerializationModifier[SerializationModifier] |1
5+h|Output Parameter
e|statusCode a|Status code |yes |xref:StatusCode[StatusCode] |1
...
5+h|Output Parameter
e|statusCode a|StatusCode |yes |xref:StatusCode[StatusCode]  |1
...
5+h|Output Parameter
e|statusCode | Status code |yes |xref:StatusCode[StatusCode] |1
...
[width=100%, cols="25%,35%,10%,20%,10%"]
|===
h|*Operation Name* 4+ePutAssetInformation
...
h|Name h|Description h|Mand. h|Type h|Card.
5+h|Input Parameter
|serializationModifier |Defines the format of the response |no |xref:SerializationModifier[SerializationModifier]  |1
5+h|Output Parameter
|statusCode |Status code |yes |xref:StatusCode[StatusCode] |1
...
|no |xref:SerializationModifier[SerializationModifier]  |1
|submodel |Submodel object |yes |Submodel |1
5+h|Output Parameter
|statusCode |Status code |yes |xref:StatusCode[StatusCode] |1
...
5+h|Output Parameter
|statusCode |Status code |yes |xref:StatusCode[StatusCode] |1
|payload |List of Asset Administration Shell Descriptors |no | xref:AssetAdministrationShellDescriptor[AssetAdministrationShellDescriptor]  |1..*
|===
...
5+h|Output Parameter
|statusCode |Status code |yes |xref:StatusCode[StatusCode]|1
|payload |Requested Asset Administration Shell Descriptor |yes | xref:AssetAdministrationShellDescriptor[AssetAdministrationShellDescriptor]  |1
|===
...
h|Name h|Description h|Mand. h|Type h|Card.
5+h|Input Parameter
|shellDescriptor |Object containing the Asset Administration Shell’s identification and endpoint informationntaining the Asset Administration Shell’s identification and endpoint information |yes | xref:AssetAdministrationShellDescriptor[AssetAdministrationShellDescriptor]  |1
5+h|Output Parameter
|StatusCode |Status code |yes |xref:StatusCode[StatusCode] |1
|payload |Created Asset Administration Shell Descriptor |yes | xref:AssetAdministrationShellDescriptor[AssetAdministrationShellDescriptor]  |1
|===
...
h|Name h|Description h|Mand. h|Type h|Card.
5+h|Input Parameter
|shellDescriptor |Object containing the Asset Administration Shell’s identification and endpoint informationcontaining the Asset Administration Shell’s identification and endpoint information |yes | xref:AssetAdministrationShellDescriptor[AssetAdministrationShellDescriptor]  |1
5+h|Output Parameter
|statusCode |Status code |yes |xref:StatusCode[StatusCode] |1
|payload |Replaced Asset Administration Shell Descriptor |yes | xref:AssetAdministrationShellDescriptor[AssetAdministrationShellDescriptor]  |1
|===
...
e|DeleteSubmodelDescriptorsById a|Deletes one or more submodel descriptors, i.e., de-registers several submodels
|===
...
5+h|Input Parameter
e|submodel +
Descriptor a|Object containing the Submodel’s identification and endpoint information |yes |SubmodelDescriptor |1
5+h|Output Parameter
e|statusCode a|Status code |yes |xref:StatusCode[StatusCode] |1
e|payload a|Created submodel descriptor |yes | xref:SubmodelDescriptor[SubmodelDescriptor]  |1
|===
...
5+h|Input Parameter
|submodel +
Descriptor	|Object containing the Submodel’s identification and endpoint information |yes	| xref:SubmodelDescriptor[SubmodelDescriptor]  	|1..*
5+h|Output Parameter
|statusCode	|Status code	|yes	|xref:StatusCode[StatusCode]	|1
|===
...
5+h|Input Parameter
e|submodel +
Descriptor a|Object containing the Submodel’s identification and endpoint information |yes | xref:SubmodelDescriptor[SubmodelDescriptor]  |1
5+h|Output Parameter
e|xref:StatusCode[StatusCode] a|Status code |yes |xref:StatusCode[StatusCode] |1
e|payload a|Replaced submodel descriptor |yes | xref:SubmodelDescriptor[SubmodelDescriptor]  |1
|===
...
5+h|Output Parameter
|statusCode |Status code |yes |xref:StatusCode[StatusCode] |1
|payload |Replaced submodel descriptor |yes | xref:SubmodelDescriptor[SubmodelDescriptor]  |1
|===
...
h|Name h|Description h|Mand. h|Type h|Card.
5+h|Input Parameter
e|serializationModifier a|Defines the format of the response |yes |xref:SerializationModifier[SerializationModifier]  |1
e|limit a|The maximum size of the result set |no |nonNegativeInteger |1
e|cursor a|The position from which to resume a result listing |no |string |1
5+h|Output Parameter
e|statusCode a|Status code |yes |xref:StatusCode[StatusCode] |1
...
|serializationModifier |Defines the format of the response |yes |xref:SerializationModifier[SerializationModifier]  |1
|limit |The maximum size of the result set |no |nonNegativeInteger |1
|cursor |The position from which to resume a result listing |no |string |1
5+h|Output Parameter
|statusCode |Status code |yes |xref:StatusCode[StatusCode] |1
...
|serializationModifier |Defines the format of the response |yes |xref:SerializationModifier[SerializationModifier]  |
|limit |The maximum size of the result set |no |nonNegativeInteger |1
|cursor |The position from which to resume a result listing |no |string |1
5+h|Output Parameter
|statusCode |Status code |yes |xref:StatusCode[StatusCode] |1
...
|yes |xref:SerializationModifier[SerializationModifier] |1
|submodel |Submodel object |yes |Submodel |1
5+h|Output Parameter
|statusCode |Status code |yes |xref:StatusCode[StatusCode] |1
|payload |Updated submodel |yes |Submodel |1
...
e|submodelDescriptor |Descriptor of a submodel of the Asset Administration Shell |xref:SubmodelDescriptor[SubmodelDescriptor] |0..*
|===
...
e|subprotocol |Allows for referencing sub-protocols that may be used in the context of that endpoint e.g. “OPC Basic SOAP” or UA Binary |xref:IdShortType[IdShortType] |0..1
...
a|Decentralized Identifiers according to the W3C Recommendation link:#bib7[[7\]]
|===
...
e|https://admin-shell.io/aas/API/3/0/RegistryServiceSpecification/SSP-001 |Indicates that the server implemented all details of the Registry Service Specification Full Profile in version 3.0.
e|https://admin-shell.io/aas/API/3/0/RegistryServiceSpecification/SSP-002 |Indicates that the server implemented all details of the Asset Administration Shell Registry Service Specification Full Profile in version 3.0.
e|https://admin-shell.io/aas/API/3/0/RegistryServiceSpecification/SSP-003 |Indicates that the server implemented all details of the Asset Administration Shell Registry Service Specification Read Profile in version 3.0.
e|https://admin-shell.io/aas/API/3/0/RegistryServiceSpecification/SSP-004 |Indicates that the server implemented all details of the Submodel Registry Service Specification Full Profile in version 3.0.
e|https://admin-shell.io/aas/API/3/0/RegistryServiceSpecification/SSP-005 |Indicates that the server implemented all details of the Submodel Registry Service Specification Read Profile in version 3.0.
...
e|https://admin-shell.io/aas/API/3/0/RepositoryServiceSpecification/SSP-001 |Indicates that the server implemented all details of the Repository Service Specification Full Profile in version 3.0.
e|https://admin-shell.io/aas/API/3/0/RepositoryServiceSpecification/SSP-002 |Indicates that the server implemented all details of the Repository Service Specification Read Profile in version 3.0.
...
===== [[StatusCode]]Generic Status Codes
...
|===
h|*Name:* h|AAS Registry Read Profile
h|*Profile Identifier:* h|https://admin-shell.io/aas/API/3/0/AssetAdministrationShellRegistryServiceSpecification/SSP-003
h|*Feature* h|Appearance
|APIs and API Operations a|
_AAS Registry API:_ +
...
h|*Profile Identifier:* h|https://admin-shell.io/aas/API/3/0/SubmodelRegistryServiceSpecification/SSP-003
h|*Feature* h|Appearance
|APIs and API Operations a|
__Submodel Registry API: +
__PostBulkSubmodelDescriptors +
