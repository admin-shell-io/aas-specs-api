...
5+h|Output Parameter
|statusCode |StatusCode |yes |xref:StatusCode[StatusCode]  |1
...
|PostBulkSubmodelDescriptors |Creates one or more new submodel descriptors, i.e., registers several submodels
|PutSubmodelDescriptorById |Replaces an existing submodel descriptor, i.e., replaces registration information
|PutBulkSubmodelDescriptorsById |Replaces one or more existing submodel descriptors, i.e., replaces registration information of several submodels
|DeleteSubmodelDescriptorById |Deletes a submodel descriptor, i.e. de-registers a submodel
|DeleteSubmodelDescriptorsById |Deletes one or more submodel descriptors, i.e., de-registers several submodels
|===
...
5+h|Output Parameter
|statusCode | StatusCode |yes |xref:StatusCode[StatusCode] |1
|payload |List of requested submodel descriptors |no |SubmodelDescriptor |1..*
|===
...
5+h|Output Parameter
|statusCode |Status code |yes |xref:StatusCode[StatusCode] |1
|payload |Created submodel descriptor |yes | xref:SubmodelDescriptor[SubmodelDescriptor]  |1
|===

==== Operation PostBulkSubmodelDescriptors
[%autowidth, width="100%", cols="h,d",]
|===
|*Operation Name* |PostBulkSubmodelDescriptors
...
Descriptor |Object containing the Submodel’s identification and endpoint information |yes | xref:SubmodelDescriptor[SubmodelDescriptor]  |1
5+h|Output Parameter
|xref:StatusCode[StatusCode] |Status code |yes |xref:StatusCode[StatusCode] |1
...
[%autowidth, width="100%", cols="h,d",]
|===
|*Operation Name* |PutBulkSubmodelDescriptorsById
...
[%autowidth, width="100%", cols="h,d",]
|===
|*Operation Name* |DeleteBulkSubmodelDescriptorsById
...
[cols="25%,40%,25%,10%"]
|===
|*Class Name* 3+e|[[Message]]Message
|*Explanation* 3+a|A message containing more information for the requester about a certain happening in the backend
|Inherits from 3+|--
|*semanticId* 3+|`\https://admin-shell.io/aas/API/DataTypes/Message/3/0`
...
[cols="30%,70%"]
|===
h|Enumeration* |[[ExecutionState]]ExecutionState
...
h|*Literal* h|*Explanation*
e|Initiated |The operation is ready to be executed (initial state)
e|Running |The operation is running
e|Completed |The operation is completed
e|Canceled |The operation was cancelled externally
e|Failed |The operation failed
e|Timeout |The operation has timed out due to given client or server timeout
|===
...
h|Inherits from 3+|--
h|h|Class Name  3+|`\https://admin-shell.io/aas/API/DataTypes/OperationHandle/3/0`

h|*Attribute* h|*Explanation* h|*Type* h|*Card.*
|handleId |Handle id |xref:ShortIdType[ShortIdType] |1
|===
...
include::./IDTA-01002_ValueOnly.adoc[] 

include::./IDTA-01002_idShortPath.adoc[] 
...
h|*Attribute* h|*Explanation* h|*Type* h|*Card.*
e|result |List of returned items. Any kind of Referables is possible, depending on the endpoint which has been requested. |Referable |0..*
e|paging_metadata |Additional information for the client to, e.g. fetch the next part of the result set. |xref:PagingMetadata[PagingMetadata] |1
|===
...
|===
|*xref:StatusCode[Generic status code]* |*Meaning* |*HTTP status code* |*Explanation*
...
|h|Class Name  |The unique identifier of this operation
|===
[%autowidth, width="100%", options="header",]
|===
|*Name* |*Description* |*Mand.* |*Type* |*Card.*
...
|h|Class Name  |The unique identifier of this class
|===
[%autowidth, width="100%", options="header"]
|===
|*Attribute +
...
|h|Class Name  |The unique identifier of this enumeration
|===
[%autowidth, width="100%", options="header",]
|===
|*Literal* |*Description*
