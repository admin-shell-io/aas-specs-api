...
* *Identify the DppMetadata Submodel*: Select the Submodel with semanticId `https://admin-shell.io/idta/cds/dppMetadata/1` (IDTA-02099-1). This Submodel provides the DPP header fields, including the Digital Product Passport ID.
