...
The formal specification can be found in xref:bibliography.adoc#bib10[[10\]].
...
xref:bibliography.adoc#bib10[[10\]]
...
Variant A is the classical graphical representation as defined in xref:bibliography.adoc#bib10[[10\]].
