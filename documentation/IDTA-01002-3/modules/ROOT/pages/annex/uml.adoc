...
The formal specification can be found in xref:bibliography.adoc#bib9[[9\]].
...
Specific graphical modelling rules, which are used in this specification but not included in this form, are explained below xref:bibliography.adoc#bib9[[9\]].
...
Variant A is the classical graphical representation as defined in xref:bibliography.adoc#bib9[[9\]].
