...
as well as similar API Operation for the AAS Registry and Submodel Registry:
xref:specification/interfaces-payload.adoc#GetAllAssetAdministrationShellDecriptorsRecentChanges[GetAllAssetAdministrationShellDescriptorsRecentChanges] 
xref:specification/interfaces-payload.adoc#GetAllSubmodelDecriptorsRecentChanges[GetAllSubmodelDescriptorsRecentChanges]. 
