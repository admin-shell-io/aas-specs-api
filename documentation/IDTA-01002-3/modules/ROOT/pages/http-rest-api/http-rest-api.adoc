...
The OpenAPI specification of the HTTP/REST APIs can be found https://industrialdigitaltwin.io/aas-specs-api/docs/swagger-ui.html[here] and, for legacy reasons, also at SwaggerHub until version v3.1.3.
