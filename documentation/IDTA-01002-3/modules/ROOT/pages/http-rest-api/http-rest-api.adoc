...
The serialization of JSON values is described in xref:bibliography.adoc#bib1[[1]].
...
// Previously pointing to Clause 12.5
To use metadata objects as described in xref:bibliography.adoc#bib1[[1]]., modifiers are implemented as HTTP query parameters or path suffixes.
