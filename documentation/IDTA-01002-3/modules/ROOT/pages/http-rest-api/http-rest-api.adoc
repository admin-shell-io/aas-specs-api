...
The specific OpenAPI documents for the different APIs are listed in the sections for the respective service specifications and profiles in Clause xref:specification/interfaces-payload.adoc#service-description[Service Description].
