...
|GetAllAssetAdministrationShellsRecentChanges |GET |/shells/$recent-changes a| _key_ and _keyIdentifier_ are mapped to base64url-encoded JSON-serialized key-value-pairs
Pagination
...
|GetAllSubmodelsRecentChanges |GET |/submodels/$recent-changes a| _key_ and _keyIdentifier_ are mapped to base64url-encoded JSON-serialized key-value-pairs
...
|GetAllConceptDescriptionsRecentChanges |GET |/concept-descriptions/$recent-changes a| Pagination
...
?createdFrom= date time according to RFC 3339, section 5.6, e.g. "2026-07-01T10:20:30Z"

?updatedFrom= date time according to RFC 3339, section 5.6, e.g. "2026-07-01T10:20:30Z"
...
|GetAllSubmodelDescriptors |GET |/submodel-descriptors a|Pagination
