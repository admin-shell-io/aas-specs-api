...
|GetAllAssetAdministrationShellRecentChanges |GET |/shells/$recent-changes a|
...
|GetAllAssetAdministrationShellDescriptors |GET |/shell-descriptors a| _key_ and _keyIdentifier_ are mapped to _assetIds_
