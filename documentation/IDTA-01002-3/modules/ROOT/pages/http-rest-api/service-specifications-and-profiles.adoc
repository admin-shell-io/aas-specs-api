...
|xref:specification/interfaces-operation-parameters.html#SerializationModifier[SerializationModifier] |not applicable
...
h|*Profile Identifier:* h|https://admin-shell.io/aas/API/3/1/DiscoveryServiceSpecification/SSP-001
h|*Feature* h|Appearance
|API and API Operations a|
...
|===
h|*Name:* h|Discovery Service Full Profile
h|*Profile Identifier:* h|https://admin-shell.io/aas/API/3/1/DiscoveryServiceSpecification/SSP-002
h|*Feature* h|Appearance
|API and API Operations a|
__AAS Basic Discovery API: +
