...
xref:IDTA-01002_General.adoc#i40-service-model[Figure in Clause General] defines that a service specification contains at least one API and that an API contains at least one API Operation.
