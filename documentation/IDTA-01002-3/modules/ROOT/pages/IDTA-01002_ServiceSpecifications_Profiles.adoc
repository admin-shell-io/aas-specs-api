...
|AssetAdministrationShellServiceSpecification/SSP-002 |Only read operations; is included in the profile Registry/SSP-001.
|===
...
h|Profile Identifier: |`\https://admin-shell.io/aas/API/3/0/DiscoveryServiceSpecification/SSP-001`
h|Feature h|Appearance
|API and API Operations a|
