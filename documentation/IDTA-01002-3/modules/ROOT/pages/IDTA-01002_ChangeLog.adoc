...
* Change the values for the ServiceDescription class from enum to a list in the OpenAPI definition for the Part 2 classes.
...
|CreateSubmodelReference| New comment in Table 15 clarifies the content of the Location header of the response. | New |
|===


=== Editorial Changes w.r.t. V3.0.1 to V3.0.2
- Fix links in Clause 12.1
- ServiceSpecificationProfileEnum: Corrected explanations for Submodel Repository profile entries
...
=== Operation Changes w.r.t. V3.0 to V3.0.1
