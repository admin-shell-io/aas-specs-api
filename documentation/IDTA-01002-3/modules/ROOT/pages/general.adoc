...
=== Nested Comparisons (todo: find better name for this effect)
...
| "https://example.com/asset-administration-shell-1" | The values for 'supplierId' and 'aas-2' exist in the same SpecificAssetId object.
| eq( "assetInformation.specificAssetIds.name", 'supplierId' ) ,  

eq( "assetInformation.specificAssetIds.value", 'aas-2' )
| "https://example.com/asset-administration-shell-1" | The values for 'supplierId' and 'aas-2' exist in the example AAS, even though in different SpecificAssetId objects.
