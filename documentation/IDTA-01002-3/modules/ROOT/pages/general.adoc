...
| le | Compares two values if they are identical. | Operator 'A le B' in https://www.w3.org/TR/xpath-30/#mapping 
| starts-with | Compares two values if they are identical. | Defined as fn:fn:starts-with in https://www.w3.org/TR/xpath-functions-30/#func-starts-with
|===
...
|
TODO: This doesn't align well with the existing RQL definitions and would be hard challenge to parse it. We need sonthing different which is more aligend with RQL
