...
====
Note: The AAS Query Language and the AAS Access Control Language xref:bibliography.adoc#bib3[[3\]] share the same BNF grammar. Therefore, the result is a superset, with `query` as the entrypoint for the Query Language. 
====
