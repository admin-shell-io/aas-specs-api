...
<<i40-service-model>> for a uniform understanding and naming.
...
====
Note: these methods are intended for the naming of interfaces as described in <<i40-service-model>>.
