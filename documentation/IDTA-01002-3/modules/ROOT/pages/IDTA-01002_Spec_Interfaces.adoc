...
e|payload a|AssetAdministrationShell | no |Replaced Asset Administration Shell |1
|===
...
5+h|Output Parameter
|StatusCode |Status code |yes |xref:StatusCode[StatusCode] |1
|payload |Replaced submodel element | no |SubmodelElement |1
|===
...
e|payload a|Replaced submodel descriptor | no | xref:SubmodelDescriptor[SubmodelDescriptor]  |1
|===
