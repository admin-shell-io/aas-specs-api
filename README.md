...
* [3.1.3](https://github.com/admin-shell-io/aas-specs-api/releases/tag/v3.1.3) is the latest bugfix release for the `V3.1.3` version of the AAS APIs, containing the normative specification and schemas of IDTA-01002-3-2.
